...
def home(request):
    ...
    if year_param:
        ...
        baseurl2 = 'https://geoserver22s.zgis.at/geoserver/IPSDI_WT23/ows?service=WFS&version=1.0.0&request=GetFeature&typeName=IPSDI_WT23%3AAsylum%20applications%20for%20Ukrainians%20in%20Europe&maxFeatures=1000&outputFormat=application%2Fjson&CQL_FILTER=year=2020'
    ...
    all_data_base_url = "https://geoserver22s.zgis.at/geoserver/IPSDI_WT23/ows?service=WFS&version=1.0.0&request=GetFeature&typeName=IPSDI_WT23:Asylum%20decisions%20for%20Ukrainian%20applicants%20in%20Europe&maxFeatures=1000&outputFormat=application/json"
    all_applications_url = "https://geoserver22s.zgis.at/geoserver/IPSDI_WT23/ows?service=WFS&version=1.0.0&request=GetFeature&typeName=IPSDI_WT23%3AAsylum%20applications%20for%20Ukrainians%20in%20Europe&maxFeatures=1000&outputFormat=application%2Fjson"
